...
import cv2
from tensorflow.keras.layers import GlobalAveragePooling2D, Dense, BatchNormalization, LayerNormalization, Dropout
...
def load_model(model_path, cls_no = 2):
    ...
    base_model = InceptionV3(
        ...
        weights='imagenet',
        input_shape=(*image_size, 3)  # Specify the input shape
    )
